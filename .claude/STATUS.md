...
Last updated after transport large-payload fixes — **two-phase registration + transparent chunking**.
...
## What's done (24 commits beyond `main`)
...
**Test totals on JDK 25:** 219 (transport-api 41, transport-netty 8,
