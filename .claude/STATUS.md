...
**Test totals on JDK 25:** 199 (transport-api 41, transport-netty 7,
server v2 73, consumer-v2 unit 52, bundle v2 engines 7, **evento-lab 12** — 6 in-memory + 6 connectivity,
**evento-lab-ms-it 7** — 3 consumer lifecycle + 2 saga lifecycle + 2 reconnect).
