...
Last updated after adding `evento-lab` end-to-end integration module — **PR3 complete + lab harness added**.
...
**Test totals on JDK 25:** 192 (transport-api 41, transport-netty 7,
...
6. Deploy `next` to staging with `evento-demo` + traffic generator.
