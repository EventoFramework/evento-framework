...
public class ServiceStressCalledEvent extends ServiceEvent {

    private String stressIdentifier;
    private long instance;
    private ZonedDateTime timestamp;

    public ServiceStressCalledEvent(String stressIdentifier, long instance) {
        this.stressIdentifier = stressIdentifier;
        this.instance = instance;
        timestamp = ZonedDateTime.now();
    }

    public ServiceStressCalledEvent() {}
