...
class BundleDescriptionParserTest {
	...
	public void test() throws Exception {
		...
		var components = applicationParser.parseDirectory(
				new File("C:\\Users\\ggalazzo\\workspace\\iris_5\\iris-server\\iris-service-plant\\src"), "https://github.com/EventoFramework/evento-framework/blob/main/evento-demo/evento-demo-agent");
