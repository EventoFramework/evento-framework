...
public abstract class DomainCommand extends Command {
	...
	public <T extends DomainCommand> T setInvalidateAggregateCaches(boolean invalidateAggregateCaches) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public  <T extends DomainCommand> T  setInvalidateAggregateSnapshot(boolean invalidateAggregateSnapshot) {
