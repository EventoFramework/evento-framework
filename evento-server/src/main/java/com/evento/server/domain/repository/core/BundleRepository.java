...
public interface BundleRepository extends JpaRepository<Bundle, String> {
	 ...
	 */
	@Query(value = "select b.id, b.version, b.autorun, b.deployable, b.bucket_type, b.description, count(distinct c.component_name) as components, string_agg(distinct p.domain, ',') as domains " +
