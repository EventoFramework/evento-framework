package org.eventrails.consumer.state.store.mysql;
...
public class MysqlConsumerStateStore extends ConsumerStateStore {
    ...
    private static final String CONSUMER_STATE_DDL = "create table if not exists "+CONSUMER_STATE_TABLE+" (id varchar(255), lastEventSequenceNumber bigint, primary key (id))";
    private static final String SAGA_STATE_DDL = "create table if not exists "+SAGA_STATE_TABLE+" (id int auto_increment, name varchar(255),  state text, primary key (id))";
