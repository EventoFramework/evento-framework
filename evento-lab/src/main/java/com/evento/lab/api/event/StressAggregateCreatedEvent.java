...
public class StressAggregateCreatedEvent extends DomainEvent {

    private String stressId;
    private long instances;

    public StressAggregateCreatedEvent() {}

    public StressAggregateCreatedEvent(String stressId, long instances) {
